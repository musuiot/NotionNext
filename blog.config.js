...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AI&ROS', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专注于AI和机器人的科技创作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://665002.xyz', // 网站地址
